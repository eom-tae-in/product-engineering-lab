...
- **운영 준비.** 배포 대상·로깅·모니터링은 아직 정하지 않았다. 실행과 환경변수는 README에 있다. 관리자 계정 생성 경로(I1)는 2026-09-03에 `AdminBootstrapRunner`로 해소했다(12번 §5.1) — 남은 환경변수는 `JWT_SECRET`과 DB 접속 정보다.
